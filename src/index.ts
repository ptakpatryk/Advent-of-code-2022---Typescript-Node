...
(async function() {
  ...
  // * PART 2
  const dayElevenPartTwoSolution = dayEleven.partTwo();
  console.log(`Day 11 (part I) - What is the level of monkey business after 10000 rounds? - ${dayElevenPartTwoSolution}.`);
